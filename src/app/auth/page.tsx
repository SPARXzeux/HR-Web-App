...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md shadow-lg bg-white border border-slate-200 rounded-xl">
        <CardHeader className="text-center pb-2">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to your HR Operations account</p>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          <div className="mt-8 border-t border-slate-200 pt-6">
            <h4 className="text-xs font-bold text-slate-505 uppercase tracking-wider mb-3">Mock Accounts for Testing</h4>
            <div className="space-y-2">
              <button 
                onClick={() => handleFillCredentials('admin@company.com', 'admin123')}
                className="w-full flex items-center justify-between p-3.5 text-left text-xs bg-slate-50 hover:bg-slate-100/80 rounded-xl transition-all border border-slate-200 active:scale-97"
              >
                <div>
                  <span className="font-bold text-slate-700">Admin Account</span>
                  <p className="text-[10px] text-slate-500 mt-0.5">admin@company.com / admin123</p>
                </div>
                <span className="px-2 py-0.5 rounded-lg bg-orange-50 text-orange-850 border border-orange-200/50 text-[10px] font-bold">Admin</span>
              </button>
              ...
              >
                <div>
                  <span className="font-bold text-slate-700">HR Account</span>
                  <p className="text-[10px] text-slate-500 mt-0.5">hr@company.com / hr123</p>
                </div>
                <span className="px-2 py-0.5 rounded-lg bg-orange-50 text-orange-850 border border-orange-200/50 text-[10px] font-bold">HR</span>
              </button>
              ...
              >
                <div>
                  <span className="font-bold text-slate-700">Employee Account</span>
                  <p className="text-[10px] text-slate-500 mt-0.5">employee@company.com / employee123</p>
                </div>
                <span className="px-2 py-0.5 rounded-lg bg-orange-50 text-orange-850 border border-orange-200/50 text-[10px] font-bold">Employee</span>
              </button>
            </div>
          </div>
        </CardContent>
